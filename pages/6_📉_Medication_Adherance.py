...
st.set_page_config(page_title="Adherence", page_icon="📉")
st.sidebar.header("Medication Adherence Analysis")

st.title("Medication adherence Analysis")
st.write(
    """This demo illustrates a result of medication adherence from a mock anonymous sample data. Enjoy!"""
)
